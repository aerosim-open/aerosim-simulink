/*
 * sl_aerosim_kafka_producer
 *
 * Based on the MathWorks reference Kafka producer S-function sl_kafka_producer.c
...
#define S_FUNCTION_NAME sl_aerosim_kafka_producer
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    {
        // Only trigger producing messages on major time steps
        return;
    }

    // mexPrintf("kafka_producer:mdlOutputs start\n");
